...
const ASSET_FILES = [
  ...
  'caracas-2026-pen-large.png',
  'chamo-2026-acrylic-large.png',
  'colorin-2021-oil-large.png',
  'el-avila-2026-gouache-large.png',
...
const DESCRIPTIONS = {
  'caracas':       'Pen-and-ink cityscape of Caracas — the skyline beneath El Ávila, with the Pepsi, Polar and Nestlé landmarks. Illustration on paper, large.',
  'el-avila':      'El Ávila in a loose, childlike painting style — the green mountain rising over the rooftops of Caracas. Gouache, large.',
  'tapas':         'A Madrid street corner — European architecture in pen and colour, the sunny façade above a libros-and-café arch.',
